...
class DomainCreate(ApiCn):
    def __init__(self, email, password, domain, **kw):
        kw.update(dict(domain=domain))
        ApiCn.__init__(self, email, password, **kw)
...
class _DomainApiBase(ApiCn):
    def __init__(self, email, password, domain_id, **kw):
...
class DomainStatus(_DomainApiBase):
    def __init__(self, email, password, status, **kw):
        kw.update(dict(status=status))
        _DomainApiBase.__init__(self, email, password, **kw)
...
class RecordType(ApiCn):
    def __init__(self, email, password, domain_grade, **kw):
...
class RecordCreate(_DomainApiBase):
    def __init__(self, email, password, domain_id, sub_domain, record_type, record_line, value, ttl, mx=None, **kw):
        kw.update(dict(
        ...
        _DomainApiBase.__init__(self, email, password, domain_id, **kw)

class RecordModify(RecordCreate):
    def __init__(self, email, password, domain_id, record_id, sub_domain, record_type, record_line, value, ttl, mx=None, **kw):
        kw.update(dict(record_id=record_id))
        RecordCreate.__init__(self, email, password, domain_id, sub_domain, record_type, record_line, value, ttl, mx=None, **kw)
 
class RecordList(_DomainApiBase):
    pass

class _RecordBase(_DomainApiBase):
    def __init__(self, email, password, domain_id, record_id, **kw):
        kw.update(dict(record_id=record_id))
        _DomainApiBase.__init__(self, email, password, domain_id, **kw)
...
class RecordDdns(_DomainApiBase):
    def __init__(self, email, password, record_id, sub_domain, record_line, **kw):
        kw.update(dict(
            record_id=record_id,
            sub_domain=sub_domain,
            record_type=record_type,
...
class RecordStatus(_RecordBase):
    def __init__(self, email, password, domain_id, record_id, status, **kw):
        kw.update(dict(status=status))
        _RecordBase.__init__(self, email, password, domain_id, record_id, **kw)
